...
urlpatterns = [
    ...
    re_path(r'^articles/(?P<article_id>\d+)/comments$', comments_views.create_comment, name='create_comment'),
    re_path(r'^articles/(?P<article_id>\d+)/like$', likes_views.toggle_like, name='like_article'),
